/* Generated By:JJTree: Do not edit this line. ASTLocalVarDef.java Version 4.3 */
...
public
class ASTLocalVarDef extends SimpleNode {
  public ASTLocalVarDef(int id) {
    super(id);
  }

  public ASTLocalVarDef(Xenon p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=e51886a2928ca8b9b1022a3274570441 (do not edit this line) */
